    ...
    <header className="bg-white shadow-sm border-b border-gray-200 px-4 sm:px-6 py-4 relative">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <button
            ...
            className="md:hidden p-2 rounded-md hover:bg-gray-100 mr-2 sm:mr-4"
          >
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-1 -right-1 h-4 w-4 bg-red-500 text-white text-xs rounded-full flex items-center justify-center min-w-[16px]">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div className="text-right hidden sm:block">
              <p className="text-sm font-medium text-gray-900 truncate max-w-24 md:max-w-32 lg:max-w-none">{user?.employee.name}</p>
      ...
      {showNotifications && (
        <>
          ...
          />
          <div className="absolute right-2 sm:right-4 md:right-6 top-full mt-2 z-50">
            <NotificationPanel 
              onClose={() => {
                setShowNotifications(false)
