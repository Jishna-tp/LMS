          ...
          {recentLeaves.length === 0 ? (
            ...
            <div className="space-y-4">
              {recentLeaves.map((leave) => (
                <div key={leave.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-lg space-y-2 sm:space-y-0">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium self-start sm:self-center ${getStatusColor(leave.status)}`}>
